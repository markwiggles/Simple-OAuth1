...
//#define CONSUMER_KEY         @"fr02lbc8vy15"
//#define CONSUMER_SECRET      @"dp01o0JnlbGiLpfa"
...
#define OAUTH_CALLBACK       @"cb" //Sometimes this has to be the same as the registered app callback url
#define CONSUMER_KEY         @"bkBTx2-zuTtDyOdgwcy6hA"//"oauth_consumer_key"
#define CONSUMER_SECRET      @"Zmf4EuQMwAuuJFkdbiLIGCzTp94" //"oauth_consumer_secret" 
#define AUTH_URL             @"https://api.yelp.com/"
#define REQUEST_TOKEN_URL    @"oauth/request_token"
#define AUTHENTICATE_URL     @"oauth/authorize"
#define ACCESS_TOKEN_URL     @"oauth/access_token"
#define API_URL              @"http://api.yelp.com/v2/search?term=cream+puffs&location=San+Francisco"
#define OAUTH_SCOPE_PARAM    @""
