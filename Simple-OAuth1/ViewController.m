                     ...
                     completion:^{
                         [self.oauth1Controller loginWithWebView:loginWebViewController.webView completion:^(NSDictionary *oauthTokens, NSError *error) {
                             if (!error) {
                                 ...
                                 self.oauthToken = @"pn_D0dWsldLbaia57FmAzGpX-ucBw6_Z";//oauthTokens[@"oauth_token"];
                                 self.oauthTokenSecret = @"7zOYu-4Ed8jLXIB2zLA5u8ROrWA";//oauthTokens[@"oauth_token_secret"];
